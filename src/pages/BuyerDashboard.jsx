              ...
              <div style={{ position:"absolute", right:0, top:"calc(100% + 8px)", width:300, background:"#fff", borderRadius:10, border:"1px solid #e5e7eb", boxShadow:"0 8px 24px rgba(0,0,0,0.12)", zIndex:200, overflow:"hidden" }}>
                ...
                <div style={{ maxHeight:320, overflowY:"auto" }}>
                  {notifs.length===0
                    ...
                    : notifs.map(n=>(
                      <div key={n.id} onClick={()=>{ markNotifRead(n.id); setShowNotifs(false); setTab("contracts"); }} style={{ padding:"0.75rem 1rem", borderBottom:"1px solid #f9fafb", background:n.is_read?"#fff":"#f0f9ff", cursor:"pointer" }}>
